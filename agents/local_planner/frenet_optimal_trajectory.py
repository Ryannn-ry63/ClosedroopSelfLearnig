...
class FrenetPlanner:
    ...
    def generate_single_frenet_path(self, f_state, Vf, df, Tf):
        """
    ...
    def reset(self, s, d, df_n=0, Tf=4, Vf_n=0, optimal_path=True):
        ...
        if optimal_path:
            ...
            self.path = self.generate_single_frenet_path(f_state, Vf=Vf, df=df, Tf=Tf)
    ...
    def run_step_single_path(self, ego_state, idx, df_n, Tf, Vf_n):
        """
